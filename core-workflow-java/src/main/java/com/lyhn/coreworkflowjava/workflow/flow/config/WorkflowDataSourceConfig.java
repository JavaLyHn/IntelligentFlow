package com.lyhn.coreworkflowjava.workflow.flow.config;
...
@Configuration
@MapperScan(basePackages = "com.lyhn.coreworkflowjava.workflow.flow.mapper", sqlSessionFactoryRef = "workflowSqlSessionFactory")
