...
public class Link {
     ...
     */
    // 把 OpenAPI 里的 paths 拆开，把每个 path 下不同 method 的 schema 都扫一遍，然后把每一个 action 具体落成一个 Tool 对象
